...
public class ModelsBio : MonoBehaviour
{
    ...
    public static string[] fan = new string[9] { "Еще какая!, Микки мой любимый член группы!", "А что за группа ?", "Я купила все их 4 альбома", "Конечно, всех 3 ребят знаю лично", "Это мой первый концерт, но я их очень люблю", "Самая Большая", "А по мне не видно?", "Самая большая фанатка в мире, люблю их до смерти", "Мне нет до них дела" };
